import type { TimetableCandidate } from '../../src/features/timetable/type';

export const timetableCandidates: TimetableCandidate[] = [
  {
    id: 1,
    title: '후보 01',
    label: '균형형',
...
export function getTimetableCandidateMock(id: string) {
  return timetableCandidates.find((candidate) => String(candidate.id) === id);
}
